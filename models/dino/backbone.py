...
from models.dino.strip_mlp import StripMLPNet
...
def build_backbone(args):
    ...
    elif args.backbone in ['strip_mlp_tiny_light']:
        backbone = StripMLPNet(in_chans=3, embed_dim=80, num_classes=1000, layers=[2, 2, 6, 2])
        backbone.init_weights(pretrained="./pretrained/checkpoint_strip_mlp_tiny_light.pth")
        bb_num_channels = [backbone.embed_dim*2, backbone.embed_dim*4, backbone.embed_dim*8]
    elif args.backbone in ['strip_mlp']:
        backbone = StripMLPNet(in_chans=3, embed_dim=80, num_classes=1000, layers=[2, 2, 12, 2])
        backbone.init_weights(pretrained="./pretrained/strip_mlp_tiny_82.09.pth")
        bb_num_channels = [backbone.embed_dim*2, backbone.embed_dim*4, backbone.embed_dim*8]
