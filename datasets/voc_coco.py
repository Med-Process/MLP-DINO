...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "train2007", root / "annotations" / 'voc2007_train.json'),
        # "train_reg": (root / "train2017", root / "annotations" / f'{mode}_train2017.json'),
        "val": (root / "val2007", root / "annotations" / 'voc2007_val.json'),
        # "eval_debug": (root / "val2017", root / "annotations" / f'{mode}_val2017.json'),
        "test": (root / "test2007", root / "annotations" / 'voc2007_test.json' ),
    }
