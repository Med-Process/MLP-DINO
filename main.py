...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='coco')    # coco voc
    ...
    parser.add_argument('--dist_url', default='env://', help='url used to set up distributed training')   # 'env://'
...
def main(args):
    ...
    if args.distributed:
        ...
        if args.backbone == "swin_T_224_1k":
